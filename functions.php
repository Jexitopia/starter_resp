<?php
/**
 * nounowstarter functions and definitions
 *
...
if ( ! function_exists( 'nounowstarter_setup' ) ) :
	/**
	 ...
	 */
	function nounowstarter_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on nounowstarter, use a find and replace
		 * to change 'nounowstarter' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'nounowstarter', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'nounowstarter_custom_background_args', array(
...
add_action( 'after_setup_theme', 'nounowstarter_setup' );
 ...
 */
function nounowstarter_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'nounowstarter_content_width', 640 );
}
add_action( 'after_setup_theme', 'nounowstarter_content_width', 0 );
 ...
 */
function nounowstarter_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'nounowstarter' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'nounowstarter' ),
...
add_action( 'wp_enqueue_scripts', 'nounowstarter_scripts' );
